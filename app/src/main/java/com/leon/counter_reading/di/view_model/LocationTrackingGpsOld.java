...
public class LocationTrackingGpsOld implements ILocationTracking {
    ...
    public static LocationTrackingGpsOld getInstance() {
        return instance;
    }

    public static void setInstance(LocationTrackingGpsOld instance) {
        LocationTrackingGpsOld.instance = instance;
    }
}
